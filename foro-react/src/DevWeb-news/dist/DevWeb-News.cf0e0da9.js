...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../js/DevWeb-News.js":[function(require,module,exports) {
// Selecciona todos los elementos li dentro de la lista con clase 'banner-buttons'
document.querySelectorAll('.banner-buttons li').forEach(function (item) {
...
searchBtn.addEventListener('click', function () {
  ...
  newsCards.forEach(function (card) {
    ...
    if (title.includes(query) || description.includes(query)) {
      ...
      result.innerHTML = "<h4>".concat(card.querySelector('h3').textContent, "</h4><p>").concat(card.querySelector('p').textContent, "</p>");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var newsButtons = document.querySelectorAll(".news-button");
  ...
  function updateIndicator() {
    slideIndicator.textContent = "Imagen ".concat(currentIndex + 1, " de ").concat(carouselItems.length);
  }
  ...
  newsButtons.forEach(function (button, index) {
...
},{}]},{},["../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../js/DevWeb-News.js"], null)
//# sourceMappingURL=/DevWeb-News.cf0e0da9.js.map